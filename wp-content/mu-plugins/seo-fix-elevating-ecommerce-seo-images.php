<?php
/**
 * Plugin Name: SEO Fix – Elevating E-Commerce SEO Image Alt Text
 * Description: Adds missing alt text and lazy loading to images on the /elevating-your-e-commerce-websites-seo/ page.
 */

add_filter( 'the_content', 'seo_fix_ecommerce_seo_images' );
function seo_fix_ecommerce_seo_images( $content ) {
	if ( ! is_singular()
		|| ! ( get_queried_object() instanceof WP_Post )
		|| 'elevating-your-e-commerce-websites-seo' !== get_queried_object()->post_name ) {
		return $content;
	}
